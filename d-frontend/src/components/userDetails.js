...
function UserProfile({}) {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      try {
        const response = await axios.get(`https://dreamspaces.onrender.com/api/userDetails`, {
          headers: {
  ...
  const updateMyDetails = async (event) => {
    ...
    try {
      const response = await axios.post(`https://dreamspaces.onrender.com/api/updateMyDetails`, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleChangePassword = async(e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`https://dreamspaces.onrender.com/api/changePassword`, passwordsState, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const confirmDelete = async(event) => {
    event.preventDefault();
    try{
      const response = await axios.post(`https://dreamspaces.onrender.com/api/deleteAccount`, {
  ...
  const handleDltProp = async (propertyId) => {
    setDltProp(false);
    try {
      const response = await axios.post(`https://dreamspaces.onrender.com/api/deleteProperty`, {
  ...
  const handleViewProperty = async (propertyId) => {
    try{
      const response = await axios.post(`https://dreamspaces.onrender.com/api/viewProperty`, {
        propertyId: propertyId
      }, {
        headers: {
          Authorization : `Bearer ${token}`
