...
describe('POST /api/commercial_sale', () => {
    it('should post commercial sale property with images', async () => {
      console.log("Sending request to /api/commercial_sale");
        const res = await request(app)
          .post('/api/commercial_sale')
          ...
          .field('water_storage', 'Corporation')
          .field('parking', 'yes')
          .field('security', 'true')
